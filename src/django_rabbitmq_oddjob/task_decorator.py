...
class oddjob:
    ...
    The `request` required keyword argument is a Django reques object. An optional `public` keyword argument, if set to `True`,
    ...
    def run_in_thread(self, args=(), kwargs={}, *, request: HttpRequest, public=False):
    ...
    def _run(self, *, args=(), kwargs={}, result_token: str, transport: AMQPTransport, public=False):
